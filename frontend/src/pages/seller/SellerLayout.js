...
import { LayoutDashboard, Store, Package, Wrench, ShoppingBag, Tag } from 'lucide-react';
import './SellerLayout.css';

const navItems = [
  { to: '/seller', icon: <LayoutDashboard size={17}/>, label: 'Dashboard', end: true },
  { to: '/seller/shops', icon: <Store size={17}/>, label: 'My Shops' },
  { to: '/seller/cities', icon: <Package size={17}/>, label: 'Cities' },
  { to: '/seller/coupons', icon: <Tag size={17}/>, label: 'Coupons' },
